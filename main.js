...
module.exports = "<section class=\"row\">\n    <aside class=\"col-md-3\">\n    </aside>\n    <main class=\"col-md-6\">\n        <h1 class=\"text-center\">About</h1>\n        <p>\n            Hi, my name is Fernando Crespo. I made this as a joke and to learn Angular 5+. I am a developer who likes everything about tech.\n        </p>\n        <p>\n            If you wanna know more about me or anything that I do head to my <a href=\"//twitter.com/fcrespo82\" target=\"_blank\">Twitter</a> or <a href=\"//github.com/fcrespo82\" target=\"_blank\">GitHub</a>. I have a <a href=\"//blog.fernando.crespo.com.br\" target=\"_blank\">blog</a> too, but I do not post frequently.\n        </p>\n    </main>\n    <aside class=\"col-md-3\">\n    </aside>\n</section>"
...
/* harmony import */ var _generator_generator_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./generator/generator.component */ "./src/app/generator/generator.component.ts");
...
/* harmony import */ var _ngx_share_buttons__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @ngx-share/buttons */ "./node_modules/@ngx-share/buttons/fesm5/ngx-share-buttons.js");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            declarations: [
                ...
                _generator_generator_component__WEBPACK_IMPORTED_MODULE_7__["GeneratorComponent"],
            ...
            imports: [
                ...
                _angular_router__WEBPACK_IMPORTED_MODULE_5__["RouterModule"].forRoot(_app_routes__WEBPACK_IMPORTED_MODULE_6__["appRoutes"]),
                _ngx_share_buttons__WEBPACK_IMPORTED_MODULE_10__["ShareButtonsModule"].withConfig()
            ],
            providers: [],
...
/* harmony import */ var _generator_generator_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./generator/generator.component */ "./src/app/generator/generator.component.ts");
...
var appRoutes = [
    { path: 'generator', component: _generator_generator_component__WEBPACK_IMPORTED_MODULE_0__["GeneratorComponent"] },
    { path: 'generator/:adjective/:animal/:version', component: _generator_generator_component__WEBPACK_IMPORTED_MODULE_0__["GeneratorComponent"] },
    { path: 'generator/:realNameID', component: _generator_generator_component__WEBPACK_IMPORTED_MODULE_0__["GeneratorComponent"] },
...
/* harmony import */ var _names__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../names */ "./src/app/names.ts");
...
var GeneratorComponent = /** @class */ (function () {
    function GeneratorComponent(client, activatedRoute, router) {
        this.client = client;
        this.activatedRoute = activatedRoute;
        this.router = router;
        this.realNames = _names__WEBPACK_IMPORTED_MODULE_4__["actual_names"];
        this.client = client;
    }
    GeneratorComponent.prototype.ngOnInit = function () {
        ...
        this.activatedRoute.params.subscribe(function (params) {
            ...
            if (params.realNameID) {
                var real = _this.realNames[Number.parseInt(params.realNameID)];
                _this.adjective = real.adjective;
                _this.animal = real.animal;
                _this.ubuntuVersion = "" + real.version;
                _this.ubuntuName = real.adjective + " " + real.animal;
                var googleUrl = "https://content.googleapis.com/customsearch/v1?q=" + _this.animal + "&searchType=image&imgSize=large&num=1&cx=000894297801806964922%3Ax3hdmbt024e&key=AIzaSyC9hDu5kAJJfR8D1JkYafbh6nM8X5NwyGI";
                _this.client.get(googleUrl).toPromise().then(function (result) {
                    _this.image = result.items[0].link;
                }).catch(function (err) {
                    _this.image = 'https://via.placeholder.com/1000?text=NO+IMAGE';
                });
            }
            else {
                _this.adjective = params.adjective;
                _this.animal = params.animal;
                _this.ubuntuVersion = "" + params.version;
                _this.ubuntuName = _this.adjective + " " + _this.animal;
                _this.image = 'https://via.placeholder.com/1000?text=Loading...';
                var googleUrl = "https://content.googleapis.com/customsearch/v1?q=" + _this.animal + "&searchType=image&imgSize=large&num=1&cx=000894297801806964922%3Ax3hdmbt024e&key=AIzaSyC9hDu5kAJJfR8D1JkYafbh6nM8X5NwyGI";
                _this.client.get(googleUrl).toPromise().then(function (result) {
                    _this.image = result.items[0].link;
                }).catch(function (err) {
    ...
    GeneratorComponent.prototype.generateName = function () {
        this.image = 'https://via.placeholder.com/1000?text=Loading...';
        var charCode = Math.round(Math.random() * 25);
        var alphabetLetter = 'abcdefghijklmnopqrstuvwxyz'[charCode];
        var chosenLetter = _names__WEBPACK_IMPORTED_MODULE_4__["ubuntu_names"][alphabetLetter];
    ...
    GeneratorComponent.prototype.pad2 = function (number) {
    ...
    GeneratorComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"],
...
/*!**************************!*\
  !*** ./src/app/names.ts ***!
  \**************************/
/*! exports provided: actual_names, ubuntu_names */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "actual_names", function() { return actual_names; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ubuntu_names", function() { return ubuntu_names; });
var actual_names = [
...
module.exports = "<figure class=\"figure w-100\" *ngIf=\"url != ''\">\n  <img [src]=\"url\" [alt]=\"title\" class=\"img-thumbnail w-100\">\n  <figcaption class=\"text-right figure-caption\">{{caption}}</figcaption>\n</figure>"
...
var PhotoComponent = /** @class */ (function () {
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", Object)
    ], PhotoComponent.prototype, "caption", void 0);
...
module.exports = __webpack_require__(/*! /home/runner/work/ubuntu-name-generator/ubuntu-name-generator/src/main.ts */"./src/main.ts");
